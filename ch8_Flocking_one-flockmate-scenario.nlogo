...
to setup
  ...
  create-turtles population
    [ set color lime - 2 + random 7  ;; random shades look nice
      set size 1.5  ;; easier to see

      set flockmates no-turtles  ;; New for behaviorSpace to avoid the run-time error.
...
to find-nearest-neighbor ;; turtle procedure
  set nearest-neighbor min-one-of flockmates [distance myself] ;; newly added code for this scenario
end
